                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-3">
                        <p className={`font-heading text-base font-semibold truncate transition ${
                          selectedShipmentId === shipment.id ? 'text-brand-900' : 'text-slate-900 group-hover:text-brand-700'
                        }`}>
                      ...
                      {(booking || trip) && (
                        <div className="mt-1 flex items-center gap-2">
                          ...
                          {trip && (
                            <span className="inline-flex items-center rounded-full bg-brand-50 px-2 py-0.5 text-[0.6rem] font-bold uppercase tracking-wider text-brand-600">
                              Trip: {trip.status}
                            </span>
                          )}
                        </div>
