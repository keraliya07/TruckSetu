...
const schema = z.object({
  ...
  JOBS_ENABLED: z.preprocess(toBoolean, z.boolean().default(true)),
  BOOKING_TIMEOUT_CRON: z.string().default('*/15 * * * *'),
  ML_RETRAIN_CRON: z.string().default('0 2 * * 0'),
  GPS_SIMULATOR_ENABLED: z.preprocess(toBoolean, z.boolean().default(true)),
